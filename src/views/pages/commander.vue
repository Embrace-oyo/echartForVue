<template>
	<div class="brigade">
		<div class="title">
			<router-link tag="div" to="/oldCamp" class="backButton">二营 > 二连</router-link>
			<div class="left"></div>
	...
	export default {
		...
		methods: {
			...
			drawMap(){
				...
				let geoCoordMap = {
					'二连': [98.024965,33.752014],
					'一排': [97.726009,33.26653],
					'二排': [97.65242,33.613585],
					'三排': [98.190541,33.285848],
				};
				let CDCData = [
					[{
						name: '二连'
				...
				let color = ['#a6c84c'];
				let series = [];
				[['二连', CDCData]].forEach(function(item, i) {
					series.push(
							{
								name: item[0],
								type: 'lines',
